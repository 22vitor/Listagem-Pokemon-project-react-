/*
   O que precisamos fazer? - quando clicarmos no botao detroca de tema temos que alterar  a cor do tema da pagina para as cores do tema claro ou dotema escuro

   objetivo 1 - quando clicar no botao de troca de tema, adicionar  a classe modo-escuro no body pra que os estilos do modo escuro sejam aplicados e mudar a imagem pra lua 
     ...
     - passo 3 - dar um jeito de identicar o clique  do usuario no botao de troca de tema 
     - passo 4 - adicionar a classe modo-escuro no body
     - passo 5 - trocar a lmagem do botao de alterar pra lua
